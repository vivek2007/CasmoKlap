jQuery(document).ready(function() {
    ...
    setTimeout(function() {
        ...
        function() {
            $("#thubmnailSlider").owlCarousel()
        }(),
        function() {
            $("#thubmnailSlider1").owlCarousel()
        }(),   
        function() {
            $("#thubmnailSlider2").owlCarousel()
        }(),   
        function() {
            $("#thubmnailSlider3").owlCarousel()
        }(), 
        function() {
            $("#thubmnailSlider4").owlCarousel()
        }(),    
        function() {
            $("#thubmnailSlider5").owlCarousel()
        }(),   
        function() {
            $("#thubmnailSlider6").owlCarousel()
        }(),     
        function() {
            $("#thubmnailSlider7").owlCarousel()
        }(),  
        function() {
            $("#thubmnailSlider8").owlCarousel()
        }(),                                                               
        function() {
            $(".thumbnailCarousel .item").each(function() {
                ...
                if ($(window).width() <= 767)
                    ...
                    for (e = 1; e < 4; e++) i = i.next(), i.length || (i = $(this).siblings(":first")), i.children(":first-child").clone().addClass("cloneditem-" + e).appendTo($(this))
            })
        }(), $(".counter").counterUp({
            delay: 10,
            time: 2e3
